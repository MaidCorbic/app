 ...
 * Presentation-only hardening.
 * Does not own gameplay state, progression, controls or audio.
 */
...
(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      /* =====================================================
         HOME — exactly one navigation stack
         ===================================================== */
      ...
      /* home-v3.js and safe-v2 both style the generated side menu.
         Keep it retired so the legacy title-secondary owner
         is the only visible stack. */
      ...
      #intro.home-v3 .title-secondary > button {
        ...
        box-shadow:
          ...
          0 0 22px rgba(255,208,110,.04)!important;
      }

      #intro.home-v3 .title-secondary > button:hover,
      #intro.home-v3 .title-secondary > button:focus-visible {
        border-color:rgba(255,208,110,.68)!important;
        transform:translateY(-1px)!important;

        box-shadow:
          inset 0 1px rgba(255,255,255,.08),
          0 16px 30px rgba(0,0,0,.30),
          0 0 28px rgba(255,208,110,.10)!important;

        outline:none!important;
      }

      #intro.home-v3 .title-secondary > button span {
        font:
          950 10px/1
          'DM Mono',
          ui-monospace,
      ...
      #intro.home-v3 .title-secondary > button small {
        font:
          750 7px/1.2
          'DM Mono',
          ui-monospace,
      ...
      #intro.home-v3 .title-secondary > [data-title-panel="controls"] {
        border-left-color:#ffe7a6!important;
      }

      #intro.home-v3 .title-secondary > #exitTitle {
        border-left-color:#b47a1e!important;
      }

      #relayInfoPanel.hidden,
      #titlePanel.hidden {
        pointer-events:none!important;
      }
      ...
      /* =====================================================
         REMOVE V10 / DYNAMIC CROWD / INTELLIGENCE HUD
         ===================================================== */
      ...
      #game [data-v10],
      #game [data-v10-hud],
      #game [data-dynamic-crowd],
      #game [aria-label*="V10"],
      #game [aria-label*="DYNAMIC CROWD"] {
        display:none!important;
        visibility:hidden!important;
        opacity:0!important;
        pointer-events:none!important;
      ...
      #game .world-marker {
        ...
        width:min(286px,28vw)!important;
        ...
        border:
          1px solid rgba(255,208,110,.26)!important;

        border-left:
          2px solid #ffd06e!important;
        ...
        box-shadow:
          ...
          0 0 24px rgba(255,208,110,.045)!important;
      ...
      #game #play .hud-progress i {
        ...
        box-shadow:
          0 0 12px rgba(255,208,110,.28)!important;
      }
      ...
      @media(max-width:760px) {
        ...
        #game .world-marker {
          left:8px!important;
          top:58px!important;
          width:min(218px,49vw)!important;
      ...
      @media(max-width:520px) {
        ...
        #game .world-marker {
          left:8px!important;
          top:54px!important;
          width:min(202px,55vw)!important;
        }
  ...
  /* =========================================================
     HIDE PHASER PRESENTATION HUD
     ========================================================= */

  const hidePhaserPresentation = () => {

    const canvas =
      $('phaser-game')?.querySelector('canvas');
    ...
    /* -------------------------------------------------------
       HIDE INDIVIDUAL PHASER TEXT OBJECTS
       ------------------------------------------------------- */
  ...
  const ensureHomeOrder = () => {
    ...
    const nav =
      intro?.querySelector('.title-secondary');
    ...
    qa(
      '[data-v3-faq],[data-v3-update],[data-v3-options],[data-v3-exit],.relay-home-nav-card,.relay-v4-home-btn',
      nav
    ).forEach(node => node.remove());


    qa(
      '[data-safe-home="faq"],[data-safe-home="update"]',
      nav
    ).forEach(node => node.remove());


    const make =
      (kind, label, detail, action) => {
