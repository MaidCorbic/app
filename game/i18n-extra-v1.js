...
(() => {
  ...
  const LANG = {
    ...
    fr:{name:'FRANÇAIS',homeEyebrow:'JEU DE LIVRAISON SUR LES TOITS',tagline:'Cours dans la ville endormie. Porte le signal plus loin que quiconque.',play:'JOUER',cont:'CONTINUER',options:'OPTIONS',optionsSub:'RÉGLAGES & COMMANDES',exit:'QUITTER',exitSub:'FERMER LA SESSION',faq:'FAQ',pause:'TERMINAL DU COURSIER',resume:'REPRENDRE',missions:'MISSIONS',progress:'PROGRESSION',settings:'RÉGLAGES',complete:'LIVRAISON TERMINÉE',nextRun:'PROCHAINE RUN',nextMission:'PROCHAINE MISSION',retry:'RÉESSAYER',signals:'SIGNAUX',language:'LANGUE',languageSub:'Changer instantanément la langue du menu et du système.'},
    it:{name:'ITALIANO',homeEyebrow:'GIOCO DI CONSEGNE SUI TETTI',tagline:'Corri nella città addormentata. Porta il segnale più lontano di chiunque.',play:'GIOCA',cont:'CONTINUA',options:'OPZIONI',optionsSub:'IMPOSTAZIONI E COMANDI',exit:'ESCI',exitSub:'CHIUDI SESSIONE',faq:'FAQ',pause:'TERMINALE DEL CORRIERE',resume:'RIPRENDI',missions:'MISSIONI',progress:'PROGRESSI',settings:'IMPOSTAZIONI',complete:'CONSEGNA COMPLETATA',nextRun:'PROSSIMA RUN',nextMission:'PROSSIMA MISSIONE',retry:'RIPROVA',signals:'SEGNALI',language:'LINGUA',languageSub:'Cambia subito la lingua del menu e del sistema.'},
    sl:{name:'SLOVENŠČINA',homeEyebrow:'IGRA DOSTAVE PO STREHAH',tagline:'Teči skozi speče mesto. Prenesi signal dlje kot kdorkoli prej.',play:'IGRAJ',cont:'NADALJUJ',options:'MOŽNOSTI',optionsSub:'NASTAVITVE IN KONTROLE',exit:'IZHOD',exitSub:'ZAPRI SEJO',faq:'FAQ',pause:'KURIRSKI TERMINAL',resume:'NADALJUJ',missions:'MISIJE',progress:'NAPREDEK',settings:'NASTAVITVE',complete:'DOSTAVA KONČANA',nextRun:'NASLEDNJI TEK',nextMission:'NASLEDNJA MISIJA',retry:'POSKUSI ZNOVA',signals:'SIGNALI',language:'JEZIK',languageSub:'Takoj spremeni jezik menija in sistema.'},
    mk:{name:'МАКЕДОНСКИ',homeEyebrow:'ИГРА ЗА ДОСТАВА НИЗ ПОКРИВИ',tagline:'Трчај низ заспаниот град. Пренеси го сигналот подалеку од сите.',play:'ИГРАЈ',cont:'ПРОДОЛЖИ',options:'ОПЦИИ',optionsSub:'ПОСТАВКИ И КОНТРОЛИ',exit:'ИЗЛЕЗ',exitSub:'ЗАТВОРИ СЕСИЈА',faq:'FAQ',pause:'КУРИРСКИ ТЕРМИНАЛ',resume:'ПРОДОЛЖИ',missions:'МИСИИ',progress:'НАПРЕДОК',settings:'ПОСТАВКИ',complete:'ИСПОРАКАТА Е ЗАВРШЕНА',nextRun:'СЛЕДЕН ТЕК',nextMission:'СЛЕДНА МИСИЈА',retry:'ОБИДИ СЕ ПОВТОРНО',signals:'СИГНАЛИ',language:'ЈАЗИК',languageSub:'Веднаш промени го јазикот на менито и системот.'}
  };
