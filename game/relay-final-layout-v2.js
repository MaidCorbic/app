...
(() => {
  ...
  const installStyles = () => {
    ...
    style.textContent = `
      ...
      #game #play .hud-route small{display:block!important;color:#38bdf8!important;font:900 7px/1 'DM Mono',monospace!important;letter-spacing:1.35px!important}
      ...
      #game #play .hud-run>small{grid-area:label!important;color:#38bdf8!important;font:900 7px/1 'DM Mono',monospace!important;letter-spacing:1.2px!important;text-transform:uppercase!important}
      ...
      #game #play .hud-run>div>i{display:block!important;height:100%!important;border-radius:99px!important;background:linear-gradient(90deg,#087ea4,#38bdf8,#8df4ff)!importantbox-shadow:0 0 12px rgba(56,189,248,.32)!important}
      ...
      #game #play .hud-xp b{display:block!important;margin-top:5px!important;color:#8df4ff!important;font:950 14px/1 'DM Mono',monospace!important;letter-spacing:.5px!important;text-align:center!important}
