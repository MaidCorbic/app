(() => {
  ...
  const STYLE_ID = 'relay-home-v3-portrait-guard-v2';
  ...
  const installPresentationStyle = () => {
    ...
    style.textContent = `
      ...
      body.home-v3-active .relay-p1-dash-status {
        display: none !important;
      }

      /* Old Dash Ready badge */
      ...
      #play .hud-route::after {
        content: "";
        position: absolute;
        inset: 1px;
        border-radius: 11px;
        box-shadow:
          inset 0 0 0 1px rgba(255, 208, 110, .04);
        pointer-events: none;
      }
      ...
      #play .hud-route .route-dot {
        ...
        height: 7px;
        flex: 0 0 auto;
        box-shadow: 0 0 14px rgba(255, 208, 110, .75);
      }
      ...
      #play .hud-route b {
        ...
        margin-top: 2px;
        letter-spacing: .06em;
        text-shadow: 0 0 12px rgba(255, 208, 110, .08);
      }
      ...
      #play .hud-progress > div {
        ...
        margin-top: 5px;
        border-radius: 999px;
        background: rgba(220, 232, 241, .08);
        overflow: hidden;
      ...
      #play .hud-xp b {
        color: #f7d98a;
        text-shadow: 0 0 12px rgba(247, 217, 138, .4);
        letter-spacing: .08em;
      }
      ...
      #play .hud-actions > button:focus-visible {
        transform: translateY(-1px);
        border-color: rgba(141, 244, 255, .72);
        box-shadow:
          inset 0 1px 0 rgba(255, 255, 255, .08),
          0 12px 28px rgba(0, 0, 0, .34),
          0 0 26px rgba(141, 244, 255, .18);
      }

      #play .world-marker {
        padding: 8px 12px;
        border: 1px solid rgba(247, 217, 138, .24);
        border-radius: 9px;
        background:
          linear-gradient(
            90deg,
      ...
      #play .world-marker b {
        letter-spacing: .05em;
        text-shadow: 0 0 12px rgba(141, 244, 255, .16);
      }
      ...
      .home-v3-play {
        ...
        box-shadow:
          ...
          0 0 32px rgba(255, 208, 110, .13),
          0 0 70px rgba(25, 200, 245, .05) !important;
        min-height: 66px;
      }
      ...
      .home-v3-play .home-v3-play-knob {
        ...
        box-shadow:
          0 0 24px rgba(255, 208, 110, .48),
          0 0 54px rgba(255, 185, 63, .2),
      ...
      .home-v3-play.is-dragging {
        border-color: rgba(141, 244, 255, .82) !important;
        box-shadow:
          inset 0 1px 0 rgba(255, 255, 255, .12),
          0 16px 38px rgba(0, 0, 0, .46),
          0 0 42px rgba(141, 244, 255, .22),
          0 0 72px rgba(255, 208, 110, .08) !important;
      }

      .home-v3-play.is-dragging .home-v3-play-fill {
        box-shadow:
          inset -2px 0 0 rgba(255, 255, 255, .34),
          0 0 32px rgba(255, 208, 110, .22);
      }
      ...
      @media (orientation: portrait) and (pointer: coarse) {
        ...
        body.home-v3-active .mobile-controls {
          display: none !important;
          pointer-events: none !important;
        }
      }
  ...
  /*
   * Synchronize Home state without touching Phaser dimensions
   * through inline style mutations.
   */
  const sync = () => {
     ...
     * IMPORTANT:
     *
     * Do not repeatedly write display/visibility/opacity/pointer-events
     * inline styles here.
     *
     * The stylesheet above is the single presentation owner.
     * This prevents unnecessary MutationObserver feedback on mobile.
     */
  };
  ...
  const boot = () => {
    ...
    /*
     * =========================================================
     * HOME PORTRAIT STABILITY
     * =========================================================
     *
     * NEVER observe document.body here.
     *
     * Phaser, HUD, animations and gameplay systems continuously
     * modify DOM classes/styles. Observing the entire body can
     * create a large callback storm on mobile and cause the Home
     * screen to appear frozen.
     *
     * #intro is the actual Home visibility owner, therefore only
     * observe #intro.
     */
