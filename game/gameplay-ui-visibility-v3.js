...
(() => {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    /* Expansion/debug panels are never part of the player-facing gameplay surface. */
    #gameplay-v11-panel,
    #gameplay-v12-panel,
    #gameplay-v13-panel,
    ...
    #gameplayEventHud,
    .gameplay-event-hud,
    #signalNetworkV1 .signal-network-card { 
    ...
    /* Remove legacy instruction strips and energy-only presentation bars.
       Phaser world-space energy traps/objects remain untouched. */
    #play .input-guide,
    #play .energy-bar,
    #play .energy-meter,
    #play .energy-hud,
    ...
    /* The yellow lower event rectangle/card is presentation-only. */
    #play #gameplayEventHud,
    #play .gameplay-event-hud,
    #gameplayEventHud .gameplay-event-card {
      display:none!important;
      visibility:hidden!important;
      opacity:0!important;
      pointer-events:none!important;
    ...
    /* Preserve the actual gameplay HUD, route information and controls. */
    #play .hud {
    ...
    #play .hud-route { border-radius:13px!important; padding:9px 12px!important; }
    #play .hud-progress { border-radius:13px!important; padding:9px 12px!important; }
    ...
    body.is-touch #play .mobile-actions button[data-mobile-action="dash"] {
      border-color:rgba(174,227,127,.7)!important;
      color:#e9ffd7!important;
      box-shadow:0 0 20px rgba(174,227,127,.14),inset 0 0 12px rgba(174,227,127,.05)!important;
    }
    ...
    @media (max-width:430px) {
      ...
      #play .hud-xp { min-width:46px!important; padding:6px!important; }
