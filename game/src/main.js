...
const game = new Phaser.Game({ type: detectTouchDevice() ? Phaser.CANVAS : Phaser.AUTO, parent: 'phaser-game', width: 1280, height: 720, backgroundColor: '#091225', render: { antialias: true, roundPixels: true, powerPreference: 'low-power', failIfMajorPerformanceCaveat: false }, physics:
