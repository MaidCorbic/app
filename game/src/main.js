...
const game = new Phaser.Game({ type: detectTouchDevice() ? Phaser.CANVAS : Phaser.AUTO, parent: 'phaser-game', width: 1280, height: 720, backgroundColor: '#091225', physics: { default: 'arcade', arcade: { gravity: { y: 1600 }, debug: false } }, scale: { mode: detectTouchDevice() ? Phaser.Scale.FIT : Phaser.Scale.RESIZE, autoCenter: Phaser.Scale.CENTER_BOTH }, scene: [] });
