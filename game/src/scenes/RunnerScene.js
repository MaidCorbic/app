...
for (const key of ['platforms','obstacles','movingGates','enemies','signals','secrets','checkpoints','boostPads','guides','safeZones','events']) {
  if (!Array.isArray(this.mission[key])) this.mission[key] = [];
}
this.runId = runId;
...
validateMission() {
  ...
  for (const key of ['platforms','obstacles','movingGates','enemies','signals','secrets','checkpoints','boostPads','guides','safeZones','events']) {
    if (!Array.isArray(mission[key])) mission[key] = [];
  }
