...
function installCardStyles() {
  ...
  style.textContent = `
    ...
    .relay-enemy-card{width:min(430px,calc(100vw - 36px));box-sizing:border-box;padding:22px;border:1px solid rgba(141,244,255,.62);background:linear-gradient(145deg,rgba(7,17,31,.98),rgba(13,27,45,.98));box-shadow:0 0 35px rgba(25,200,245,.16),0 20px 60px rgba(0,0,0,.48);color:#f4f7fb;font:500 14px/1.45 system-ui,sans-serif}
    .relay-enemy-card .eyebrow{margin:0 0 7px;color:#8df4ff;font:700 11px/1.2 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.16em}
    .relay-enemy-card h2{margin:0 0 14px;font-size:28px;line-height:1.05;letter-spacing:.03em}
