...
RunnerScene.prototype.create = function stableCreate(...args) {
  ...
  try {
    // World-interaction lifecycle is owned by world-interaction-runtime-v2.js.
    // Keeping it out of this stability wrapper prevents duplicate create/update hooks.
...
RunnerScene.prototype.update = function stableUpdate(time, delta) {
  ...
  // World-interaction update is owned by world-interaction-runtime-v2.js.
