    ...
    function (...args) {
      ...
      ui.add(
        txt(
          ...
          px + 14,
          py + 34,
          'M MIRROR   Y SYMBOLS   U MEMORY   P PHOTO',
          '7px',
          '#7896a4'
        ).setOrigin(0)
      );
      ...
      const rotateMirror = () => {
        ...
        setStatus(
          state.mirror.solved
            ? 'MIRROR ROUTE CONNECTED — GATE OPEN'
            : 'MIRROR ROTATED — ALIGN TO 180°'
        );
      };
      ...
      const key = e => {
        ...
        switch (e.code) {
          ...
          case 'KeyU':
            ...
            setStatus(
              state.memory.revealed
                ? 'MEMORY LANDMARKS REVEALED'
                : 'MEMORY LANDMARKS HIDDEN'
            );
