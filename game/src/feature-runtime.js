...
import { installCharacterEvolution } from './systems/character-evolution-v1.js';
...
import { installFirstMapPuzzleGate } from './systems/first-map-puzzle-gate-v1.js';
...
if (!RunnerScene.prototype.__relayFeatureRuntimeInstalled) {
  ...
  installCharacterEvolution(RunnerScene);
  ...
  installFirstMapPuzzleGate(RunnerScene);
