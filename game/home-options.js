...
(() => {
  ...
  style.textContent = `
    ...
    .home-options-final{display:grid;gap:8px;width:100%;box-sizing:border-box}
    .home-section{margin:4px 2px 0;color:#5f7287;font:800 8px/1 'DM Mono',monospace;letter-spacing:1.2px}
    ...
    .home-opt-copy{min-width:0;overflow:hidden}.home-opt-copy b{display:block;color:#e9f2f8;font:800 9px/1.15 'DM Mono',monospace;letter-spacing:.7px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.home-opt-copy small{display:block;margin-top:3px;color:#68798c;font:700 7px/1.35 'DM Mono',monospace;overflow-wrap:anywhere}
    .home-opt button{box-sizing:border-box;min-width:92px;height:34px;padding:0 10px;border:1px solid rgba(210,226,240,.18);border-radius:7px;background:#07111ff2;color:#e9f2f8;font:800 8px 'DM Mono',monospace;letter-spacing:.6px;cursor:pointer;touch-action:manipulation}.home-opt button.is-on{border-color:rgba(104,231,190,.55);color:#68e7be}.home-opt button:hover,.home-opt button:focus-visible{border-color:#ffd06e;color:#ffd06e;outline:none}
    ...
    .home-lang{position:relative}.home-lang-menu{position:absolute;right:0;top:calc(100% + 6px);z-index:50;width:170px;max-width:calc(100vw - 32px);padding:5px;border:1px solid rgba(210,226,240,.18);border-radius:8px;background:#07111ff8;box-shadow:0 14px 40px #000b}.home-lang-menu.hidden{display:none}.home-lang-menu button{display:block;width:100%;height:34px;border:0;background:transparent;color:#c9d5e0;text-align:left;font:800 8px 'DM Mono',monospace;cursor:pointer}.home-lang-menu button.active,.home-lang-menu button:hover{background:rgba(255,208,110,.08);color:#ffd06e}
  ...
  const init=()=>{const panel=document.getElementById('titlePanel');if(!panel)return;document.querySelectorAll('[data-title-panel="controls"]').forEach(button=>button.addEventListener('click',()=>window.setTimeout(render,30)));new MutationObserver(()=>window.setTimeout(render,30)).observe(panel,{attributes:true,attributeFilter:['class']});};
