(() => {
  ...
  sunStyle.textContent = `
    ...
    #intro.intro[data-atmosphere=dawn] .backdrop-sun,#intro.intro[data-atmosphere=day] .backdrop-sun,#intro.intro[data-atmosphere=dusk] .backdrop-sun{opacity:1}
  ...
  const updateSun = hour => {
    ...
    // Continuous arc: sunrise 05:00, highest point at noon, sunset 20:00.
