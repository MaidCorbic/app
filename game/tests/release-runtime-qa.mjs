...
assertNoPairwiseOverlap(
  ...
  `Mobile action layout ${viewport.width}x${viewport.height}`,
    ...
    // Pause is the in-game mobile system surface. Settings wiring is covered
    // by the release-hardening contract so this runtime pass stays focused on
    // actual touch gameplay and pause/resume interaction.
