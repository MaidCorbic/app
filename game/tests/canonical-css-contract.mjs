...
// The six static touch actions are the only markup action controls.
assert.equal((index.match(/data-mobile-action=/g) || []).length, 6);

// Base stylesheet contains the legacy duplicate small rule; canonical CSS deliberately owns the
// final mobile presentation and keeps the duplicate from affecting the rendered surface.
