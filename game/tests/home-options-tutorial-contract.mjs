...
assert.match(options, /home-options-zipper/);
assert.match(options, /home-zip-pull/);
...
assert.match(tutorial, /tutorial-zipper/);
assert.match(tutorial, /tutorial-zip-pull/);
