...
assert.match(unified, /data-unified-jump/);
assert.match(unified, /data-option-section="gameplay"/);
assert.match(unified, /data-option-section="audio"/);
assert.match(unified, /data-option-section="interface"/);
assert.match(unified, /data-option-section="graphics"/);
assert.match(unified, /data-option-section="system"/);
assert.match(unified, /data-unified-close/);
