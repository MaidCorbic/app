...
(() => {
  const install = () => {
    ...
    const syncHudVisibility = () => {
      ...
      const gameplayVisible = !document.getElementById('intro')?.classList.contains('hidden');
      ...
      hud.classList.toggle('is-active', touch && playVisible && !gameplayVisible && !finishVisible && !gameOverVisible && !pauseVisible);
    };
