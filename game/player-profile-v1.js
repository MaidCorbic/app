    ...
    <section id="playerProfile" aria-label="Player profile and progression">
      <div class="pp-shell">
        <header class="pp-head">
          <div>
            <p class="pp-kicker">COURIER PROFILE // LIVE STATE</p>
            <h2 class="pp-title">PLAYER <em>PROGRESSION.</em></h2>
            <p class="pp-sub">Your profile is calculated directly from the current game save. No duplicate progression state is created.</p>
          </div>
