  ...
  const rangeCard = (
    ...
    `<article class="relay-ui-card">
      ...
      <div class="relay-ui-range">
        <div class="relay-ui-range-head">
          <span>LEVEL</span>
          <b data-unified-range-value="${key}">
  ...
  const renderOptionsBody = () => {
    ...
    return `
      <div class="relay-section-grid">
        ...
        <section class="relay-ui-section">
          <div class="relay-ui-section-title">
            GAMEPLAY
          </div>
        ...
        <section class="relay-ui-section wide">
          <div class="relay-ui-section-title">
            PRESENTATION
          </div>
        ...
        <section class="relay-ui-section">
          ...
          <article class="relay-ui-card">
            <div class="relay-ui-copy">
              ...
              <small>
                Choose the menu language used by the relay.
              </small>
            </div>
        ...
        <section class="relay-ui-section">
          ...
          <article class="relay-ui-card">
            <div class="relay-ui-copy">
              ...
              <small>
                Use the browser's native fullscreen mode when supported.
              </small>
            </div>
          ...
          <article class="relay-ui-card">
            <div class="relay-ui-copy">
              ...
              <small>
                Responsive layout is shared between web and mobile.
              </small>
            </div>
        ...
        <section class="relay-ui-section wide">
          ...
          <div class="relay-ui-controls">
            <span class="relay-ui-key">
              <kbd>A</kbd><b>/</b><kbd>D</kbd> MOVE
            </span>
      ...
      <div class="relay-cinematic-panel">
        ...
        <header class="relay-cinematic-head">
          <div>
            ...
            <p class="relay-cinematic-subtitle">
              Configure audio, gameplay, presentation and controls without leaving the relay.
            </p>
          </div>
  ...
  const ensurePauseShell = () => {
    ...
    shell.innerHTML = `
      <header class="relay-pause-head">
        ...
        <div class="relay-pause-brand">
          <span class="relay-pause-mark">
            R/
          </span>
        ...
        <div class="relay-pause-state">
          GAME PAUSED · SYSTEM STANDBY
        </div>
      ...
      <div class="relay-pause-layout">

        <nav
          class="relay-pause-nav"
        ...
        <section class="relay-pause-content"></section>
      ...
      content.innerHTML = `
        <div class="relay-cinematic-panel">
          <div class="relay-cinematic-body">
            ...
            <div class="relay-ui-section wide">
              ...
              <article class="relay-ui-card">
                ...
                <div class="relay-ui-copy">
                  ...
                  <small>
                    Your current run is paused safely. Resume returns control immediately.
                  </small>
                </div>
      ...
      content.innerHTML = `
        <div class="relay-cinematic-panel">
          <div class="relay-cinematic-body">
            ...
            <div class="relay-section-grid three">
