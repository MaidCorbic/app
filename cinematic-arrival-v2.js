/* ROOT CINEMATIC ARRIVAL FALLBACK
   index.html is served from a rewritten root path on Vercel, so the legacy
   ./cinematic-arrival-v2.js request resolves here. Keep this presentation-only.
*/
(() => {
  'use strict';
